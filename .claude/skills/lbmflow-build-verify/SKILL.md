...
| Docs only (`docs/**`, `*.md`) | None — but confirm CLAUDE.md/AGENTS.md stayed in sync (see Step 3) |
...
CLAUDE.md (Claude agents) and AGENTS.md (codex/other agents) must stay in sync —
...
committing. A drift between them silently gives codex and Claude different rules.
