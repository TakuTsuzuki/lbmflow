...
| REV-5 | **Velocity inlet + pressure outlet DONE 2026-07-07** (NEBB closure, CPU; moment exactness ~1e-17, duct L2 2.1e-4, D3Q19 consistency 3.4e-4, T13 BC-seam bit-exact). Remaining: D3Q27 outflow/convective closures, GPU open-face kernels. |
