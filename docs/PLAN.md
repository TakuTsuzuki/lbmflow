...
| REV-5 | **D3Q27 open-face CPU support + scenario JSON exposure DONE 2026-07-07** (NEBB/open closures, CPU; moment exactness ~1e-17, duct L2 2.1e-4, D3Q19 consistency 3.4e-4, T13 BC-seam bit-exact; `grid.lattice: "d3q27"` exposed with GPU open-face rejection). Remaining: GPU open-face kernels. |
