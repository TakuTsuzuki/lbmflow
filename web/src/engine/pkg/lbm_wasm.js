...
export class WasmSim {
    ...
    init(cfg_json) {
        ...
        const ret = wasm.wasmsim_init(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     */
    nx() {
        const ret = wasm.wasmsim_nx(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    ny() {
        const ret = wasm.wasmsim_ny(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    rho_ptr() {
        const ret = wasm.wasmsim_rho_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    set_solid(x, y, solid) {
        const ret = wasm.wasmsim_set_solid(this.__wbg_ptr, x, y, solid);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    solid_ptr() {
        const ret = wasm.wasmsim_solid_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} n
     */
    step(n) {
        wasm.wasmsim_step(this.__wbg_ptr, n);
    }
    /**
     * @returns {number}
     */
     ...
     */
    ux_ptr() {
        const ret = wasm.wasmsim_ux_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    uy_ptr() {
        const ret = wasm.wasmsim_uy_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
}
