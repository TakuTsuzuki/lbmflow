...
//!
//! Identical contract to V1 (`lbm_core::real::Real`); duplicated here because
//! V1 is frozen as a reference implementation and V2 must not build-depend on
//! it (V1 is a dev-dependency of the equivalence tests only).
